...
lucky({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/luckytechhub/Lucky-XD/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/luckytechhub/Lucky-XD/archive/main.zip", { responseType: "arraybuffer" });
